...
class MediaExtractor:
    ...
    def _translate_error(self, error: str) -> str:
        ...
        translations = {
            ...
            "confirm you're not a bot": "يوتيوب حجب الطلب مؤقتاً (فحص روبوت) - الرابط سليم، انتظر بضع دقائق ثم أعد المحاولة",
            "not a bot": "يوتيوب حجب الطلب مؤقتاً (فحص روبوت) - الرابط سليم، انتظر بضع دقائق ثم أعد المحاولة",
